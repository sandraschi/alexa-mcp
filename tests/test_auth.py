...
class TestAuthenticate:
    def test_correct_credentials_allowed(self, auth_client, monkeypatch):
    ...
    def test_wrong_password_rejected(self, auth_client, monkeypatch):
        monkeypatch.setenv("ALEXA_WEB_USER", "sandra")
        monkeypatch.setenv("ALEXA_WEB_PASS", "vienna2026")
    ...
    def test_wrong_username_rejected(self, auth_client, monkeypatch):
        monkeypatch.setenv("ALEXA_WEB_USER", "sandra")
        monkeypatch.setenv("ALEXA_WEB_PASS", "vienna2026")
    ...
    def test_custom_env_credentials(self, auth_client, monkeypatch):
    ...
    def test_default_credentials_still_rejected_when_custom_set(self, auth_client, monkeypatch):
        monkeypatch.setenv("ALEXA_WEB_USER", "alice")
        monkeypatch.setenv("ALEXA_WEB_PASS", "s3cr3t!")
