...
const KINDS = ["", "interaction", "tool_call", "bridge", "server", "system"] as const;
        ...
        <div className="space-y-6">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                <div>
                    ...
                    <h2 className="mt-1 text-2xl font-bold tracking-tight text-white">Logs</h2>
                    <p className="text-slate-400">
                        Interactions, tool calls, bridge sessions, and server events — ring buffer (
                        <code className="text-xs">ALEXA_LOG_MAX_ENTRIES</code>)
                    </p>
                </div>
            ...
            {stats && (
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                    {[
                        ...
                        {
                            label: "Interactions",
                            value: (stats.by_kind.interaction ?? 0).toLocaleString(),
                        },
                    ].map((item) => (
                        <Card
                            key={item.label}
            ...
            <Card className="border-slate-800 bg-slate-950/60 backdrop-blur">
                <CardHeader className="pb-3">
                    ...
                    <CardDescription className="text-slate-400">
                        Search, filter by level/kind, paginate — live tail on page 1 (newest first)
                    </CardDescription>
                </CardHeader>
                <CardContent className="flex flex-col gap-4">
                    <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6">
                        <div className="space-y-1.5">
                            ...
                            <Input
                                placeholder="tool, command, error…"
                                value={searchDraft}
                        ...
                        <div className="space-y-1.5">
                            ...
                            <Button
                                variant="outline"
                                className="w-full justify-between border-slate-700 bg-slate-900/80 text-slate-200"
                                onClick={() => {
