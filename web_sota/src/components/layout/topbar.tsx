...
export function Topbar() {
    const handleLogout = () => {
        // Basic Auth logout trick: send invalid credentials or clear cache
        // browser-side Basic Auth is persistent in session.
        // For SOTA 2026, we'll just redirect to a 401 trigger or just reload
